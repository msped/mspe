...
from .views import AllProjects, ProjectView, TaskView, IssueView, ToggleTask, TaskEdit, DeleteTask, ToggleIssue, IssueEdit, DeleteIssue, AddTask, AddIssue
...
urlpatterns = [
    ...
    path('<int:p_id>/add/issue', AddIssue.as_view(), name="add_issue"),
]